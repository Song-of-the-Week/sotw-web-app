...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def update(self, session: Session, *, db_object: ModelType, object_in: Union[UpdateSchemaType, Dict[str, Any]]) -> ModelType:
        """
        ...
        update_data = object_in if isinstance(object_in, dict) else object_in.model_dump(exclude_unset=True)
