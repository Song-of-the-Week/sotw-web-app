...
class Response(Base):
    ...
    matched_users_songs: Mapped[List[UserSongMatch]] = relationship(back_populates='response')
    ...
    submitter = relationship('User', foreign_keys=submitter_id, back_populates='responses')
